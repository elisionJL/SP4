...
namespace DigitalRuby.PyroParticles
{
    ...
    public class MeteorSwarmScript : FireBaseScript, ICollisionHandler
    {
        ...
        private IEnumerator SpawnMeteor()
        {
            ...
            Vector3 src = Source.transform.position + new Vector3(0, 30, 0) + (UnityEngine.Random.insideUnitSphere * SourceRadius);
            ...
            Vector3 dest = Source.transform.position + ((Source.transform.forward + UnityEngine.Random.insideUnitSphere) * DestinationRadius);
            dest.y = 0.0f;
        ...
        protected override void Update()
        {
            ...
            if (Duration > 2.0f && (elapsedSecond += Time.deltaTime) >= 1.0f)
            {
